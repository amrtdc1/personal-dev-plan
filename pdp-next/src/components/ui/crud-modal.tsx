...
export function CrudModal({ isOpen, title, onClose, children }: CrudModalProps) {
  ...
  return createPortal(
    ...
    >
      <div
        className="pdp-card pdp-modal-theme flex w-full max-w-2xl max-h-[calc(100dvh-6rem)] flex-col overflow-hidden rounded-2xl p-4 shadow-2xl sm:max-h-[min(82vh,56rem)] sm:p-5"
        role="dialog"
        aria-modal="true"
        aria-label={title}
