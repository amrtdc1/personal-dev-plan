        ...
        <div className="pdp-panel-muted pdp-panel-muted-mobile-flat rounded-xl p-3">
            ...
            {todaysAgenda.length > 0 ? (
              <ul className="pdp-divider-list mt-2 space-y-0">
                {todaysAgenda.slice(0, 8).map((agendaItem) => (
                  <li key={agendaItem.id} className="pdp-card-mobile-ghost rounded-lg bg-slate-50/80 p-2">
                    <div className="flex items-start justify-between gap-2">
          ...
          >
            <form onSubmit={handleEditSubmit} className="grid gap-3">
              {selectedEventRef ? (
                <>
                  <p className="pdp-card-mobile-ghost rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-600">
